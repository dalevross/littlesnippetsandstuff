!function(t) {
    ...
    var i = {
        create: function(t) {
            var e, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
            if (e = -1 === i.SVG_ELEMENTS.indexOf(t) ? document.createElement(t) : document.createElementNS(i.SVG_NAMESPACE, t),
        ...
        icon: function(t) {
            var e = i.create("use");
            return e.setAttributeNS(i.XLINK_NAMESPACE, "href", "#icon-" + t),
            i.create("svg", {
                class: "icon"
            }, [e])
        },
    ...
    var a = function() {
      ...
      , r = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                for (; !this.isComplete(); )
                    this.addDot(Math.floor(9 * Math.random()))
            }
        }, {
            key: "addDot",
            value: function(t) {
                if (this.isComplete() || ~this.suite.indexOf(t))
                    return [];
                ...
                if (void 0 != e && n >> 0 === n && e % 3 - n % 3 == n % 3 - t % 3 && Math.floor(e / 3) - Math.floor(n / 3) == Math.floor(n / 3) - Math.floor(t / 3)) {
                    var i = this.addDot(n);
                    return this.isComplete() || (this.suite.push(t),
                    i.push(t)),
                    i
                }
                return this.suite.push(t),
                [t]
            }
        }, {
            key: "isComplete",
            ...
            value: function(t) {
                for (var e = 0, n = 0, i = 0; i < this.dotLength; i++) {
                    ...
                    for (var a = 0; a < this.dotLength; a++)
                        this.suite[a] === t.suite[i] && n++
                }
      ...
      , s = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                e.fill = e.fill || "#fff";
                for (var i = 0; i < 9; i++)
                    n.push(o.default.create("circle", {
            ...
            value: function(t, e, n) {
                ...
                for (var h = [], d = 0; d < i; d++)
                    h.push(o.default.create("circle", {
                        cx: l + d * u,
                        cy: c,
...
, function(t, e, n) {
    ...
    function o(t) {
        if (t.counter -= 1,
        t.counter <= 0)
            return t.el.textContent = t.originalText,
            void a(t.el);
        var e = Math.floor(t.originalLength - t.counter / h);
        t.el.textContent = t.originalText.substr(0, e) + s(Math.min(t.originalLength - e, 3)),
        r(t)
    }
    function s(t) {
        var e = ""
...
, function(t, e, n) {
    ...
    var i = function(t, e) {
        for (var n = Math.abs(t) + "", i = t < 0, a = e - n.length; a > 0; a--)
            n = "0" + n;
        return (i ? "-" : "") + n
    };
    e.default = i
...
, function(t, e, n) {
    ...
    var C = function() {
        ...
        return r(t, [{
            key: "setupTemplate",
            value: function() {
                return this.el = T.default.create("div", "game-layout view", [T.default.create("div", "view-bloc game-layout-dashboard", [this.statusBar.el, T.default.create("div", "history-wrap", [this.history.el])]), T.default.create("div", "view-bloc game-layout-lock", [this.lock.el]), this.summary.el]),
                this.el
            }
        }, {
            key: "start",
            ...
            value: function(t) {
                ...
                this.isEnded)
                    ...
                    case b.default.GAME.TYPE.PRACTICE:
                        ...
                        break;
                    case b.default.GAME.TYPE.CHALLENGE:
                        0 === this.statusBar.decrementCounter() && (this.isEnded = !0,
                        this.summary.setContent(!1, this.count))
                    }
                return this.history.stackPattern(n),
                i
            }
        }, {
            key: "abort",
            value: function(t) {
                ...
                this.summary.setContent(!1, this.count)) : this.onEnd()
            }
        }, {
            key: "action",
            value: function(t) {
            ...
            value: function(t, e) {
                var n = new m.default;
                n.addDots(1),
                n.addPattern(t, 14, w.default.greydient(b.default.PATTERN.HEX_COLOR_START, b.default.PATTERN.HEX_COLOR_END, t.dotLength - 3)),
                e && m.default.prototype.addCombinaison.apply(n, e);
                var i = n.getSVG();
                return e[0] === t.dotLength && i.classList.add("success"),
                i
            }
        }]),
        t
        ...
        return r(t, [{
            ...
            value: function() {
                var t = v.default.create("h1", "menu-title highlight unselectable", "BreakLock")
                  , e = v.default.create("p", "menu-intro", "A hybrid of Mastermind and the Android pattern lock. A game you gonna love to hate.");
                this.title = t,
                ...
                this.el = v.default.create("div", "menu-layout view", [v.default.create("div", "view-bloc menu-layout-instructions", [t, e, n.el]), v.default.create("div", "view-bloc menu-layout-form", [this.difficultyOption.el, this.typeSelector.el, this.typeHelpEl, this.btnStarlEl])]),
                this.el
            }
        }, {
            key: "init",
            ...
            value: function() {
                localStorage.getItem("isDeepBlack") ? (localStorage.setItem("isDeepBlack", ""),
                document.body.classList.remove("deepblack")) : (localStorage.setItem("isDeepBlack", "on"),
    ...
    var c = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                return this.el = l.default.create("div", "countdown", [this.counterEl, t]),
                this.el
            }
        }, {
            key: "setTimer",
    ...
    var s = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                return this.buttonEl = o.default.create("button", "extender-button", this.title),
                this.contentEl = o.default.create("div", "extender-content", t),
                this.el = o.default.create("div", "extender small-only", [this.buttonEl, this.contentEl]),
                this.render(),
                this.el
            }
        }, {
            ...
            key: "toggle",
            value: function(t) {
                this.isExpanded = t instanceof Boolean ? t : !this.isExpanded,
                this.render()
            }
        }, {
            key: "render",
...
, function(t, e, n) {
    ...
    var s = function() {
        ...
        return a(t, [{
            key: "setupTemplate",
            value: function() {
                return this.containerEl = o.default.create("div", "history-container", ""),
                this.el = o.default.create("div", "history scrollbarlesque", [this.containerEl]),
                this.el
            }
        }, {
            key: "stackPattern",
            value: function(t) {
                this.lastPattern ? this.containerEl.insertBefore(t, this.lastPattern) : this.containerEl.appendChild(t),
                this.lastPattern = t,
                this.scrollToStart()
            }
        }, {
            ...
            value: function() {
                ...
                this.el.scrollLeft = (Math.max(t / 4, 4),
                0),
                this.el.scrollLeft > 0 && window.requestAnimationFrame(this.scrollToStart.bind(this))
            }
        }, {
            key: "clear",
            value: function(t) {
...
, function(t, e, n) {
    ...
    var p = function() {
        ...
        return r(t, [{
            ...
            value: function(t) {
                this.dotLength = t,
                this.pattern = new s.default(this.dotLength)
            }
        }, {
            key: "mouseStart",
            value: function(t) {
            ...
            value: function() {
                ...
                this.currentLine = null;
                for (var t = 0; t < 9; t++)
                    this.bigDotsEl.childNodes[t].classList.remove("active");
            ...
            value: function() {
                ...
                return this.isPendingReset = setTimeout(this.reset.bind(this), 1e3),
                this.patternEl.setAttribute("stroke", t ? f.default.COLORS.SUCCESS : f.default.COLORS.ERROR),
                t
            }
        }, {
            key: "startLine",
            ...
            key: "updateLine",
            value: function(t, e) {
                this.currentLine && (this.currentLine.setAttribute("x2", t),
                this.currentLine.setAttribute("y2", e))
            }
        }, {
            key: "closeLine",
            value: function(t, e) {
...
, function(t, e, n) {
    ...
    var s = function() {
        ...
        return a(t, [{
            key: "setupTemplate",
            value: function() {
                return this.el = o.default.create("div", "selectbox"),
                this.el
            }
        }, {
            key: "setChoices",
            ...
            value: function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                this.selectFromTag(t.currentTarget)
            }
        }, {
            key: "selectFromTag",
            value: function(t) {
...
, function(t, e, n) {
    ...
    var s = function() {
        ...
        return a(t, [{
            key: "setupTemplate",
            value: function() {
                return this.btnLeft = o.default.create("span", "selectbox-item active selector-left", "<"),
                this.btnRight = o.default.create("span", "selectbox-item active selector-right", ">"),
                this.labelEl = o.default.create("span", "selectbox-item selector-label"),
                this.el = o.default.create("div", "selector selectbox", [this.btnLeft, this.btnRight, this.labelEl]),
                this.el
            }
        }, {
            key: "init",
            ...
            value: function() {
                ...
                return this.labelEl.textContent = t.label,
...
, function(t, e, n) {
    ...
    var d = function() {
        ...
        return r(t, [{
            key: "setupTemplate",
            value: function() {
                return this.cancelBtnEl = h.default.create("button", "status-bar-cancel", "ABORT"),
                ...
                this.el = h.default.create("div", "status-bar", [this.cancelBtnEl, this.counterEl, this.countdownEl]),
                this.el
            }
        }, {
            key: "init",
            ...
            key: "updateCounter",
            value: function() {
                return this.counterEl.textContent = (0,
                l.default)(this.counterVal, 3),
                this.counterVal
            }
        }, {
    ...
    var y = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                var a = f.default.create("div", "summary-feedback bloc", [f.default.create("p", {}, [f.default.create("span", {}, "Tweet me your feedback at "), f.default.create("a", {
                ...
                this.revealEl = f.default.create("p", "summary-reveal", "Continue to see the solution."),
                ...
                this.el = f.default.create("div", "summary view", [f.default.create("div", "view-bloc", [this.titleEl, this.detailsEl, this.revealEl]), f.default.create("div", "view-bloc", [this.actionsEl, this.socialEl, a])]),
                this.el
            }
        }, {
            key: "init",
            ...
            value: function(t, e) {
                ...
                (0,
                v.default)(this.titleEl, t ? "Success!" : "Fail!"),
                this.detailsEl.textContent = (0,
                s.default)(t, e),
...
, function(t, e, n) {
    ...
    function i(t, e) {
        var n = void 0
          , i = void 0;
        return t ? (n = "Lock found in " + e + " attempts. ",
        i = a.filter(function(t) {
            return t.min <= e && t.max >= e
        }).map(function(t) {
            return t.text
        })) : (n = "Sorry, you didn't make it this time. ",
        i = r),
