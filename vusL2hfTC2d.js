    ...
    a = function() {
        ...
        c.$1 = function(c, d) {
            ...
            for (var f = arguments.length, h = new Array(f > 2 ? f - 2 : 0), i = 2; i < f; i++)
                h[i - 2] = arguments[i];
            var j = this.error, k = this.project, l = this.metadata, m = this.forcedKey, n, o;
            if (j) {
                o = j.name;
                ...
                var p = b("ErrorSerializer").parse(j.message)
                  , q = p.taalOpcodes
                  , r = m && p.forcedKey ? m + "_" + p.forcedKey : m || p.forcedKey;
                n = {
                    message: d + " from %s: %s",
                    params: [].concat(h, [o, b("ErrorSerializer").toFormattedMessageNoTAAL(p)]),
                    taalOpcodes: q,
                    forcedKey: r
                }
            } else
            ...
            var s = b("ErrorSerializer").stringify(n)
              , t = b("ErrorNormalizeUtils").normalizeError((e = j) != null ? e : new Error(s), {
                message: s,
                name: o,
                project: k,
                type: c
            });
            t.loggingSource = "FBLOGGER";
            l.isEmpty() || (t.fbloggerMetadata = l.formatMetadata());
            (g || (g = b("ErrorPubSub"))).reportNormalizedError(t)
        }
        ;
        c.fatal = function(a) {
            for (var b = arguments.length, c = new Array(b > 1 ? b - 1 : 0), d = 1; d < b; d++)
...
__d("CSSLoader", ["CSSLoaderConfig", "ResourceTimingsStore", "TimeSlice", "clearInterval", "ifRequired", "isEmpty", "nullthrows", "setIntervalAcrossTransitions"], (function(a, b, c, d, e, f) {
    __p && __p();
        ...
        d.$31 = function(a, c, d, e, f, g, i) {
            ...
            b("TimeSliceInteractionBootloadForPost")(function(c, o, p, q, r, s, t) {
                ...
                if ((j || (j = b("performance"))) && (j || (j = b("performance"))).timing && (j || (j = b("performance"))).timing.navigationStart) {
                    ...
                    q = q.getMetrics(u != null && u < k.$18 ? u : k.$18, {}, null, a, !0, !0);
                    u = q.data;
                    q = q.diagnostics;
